...
# Informações principais do usuário(nome, data de nascimento, cpf, telefone, função)
    nome = models.CharField(max_length=300, null=False, blank=False, default="")
    data_nasc = models.DateField(null=False, blank=False, default=timezone.now)
...
# Informações da camisa(número, nome, quantidade, tipo, tamanho)
    nomec = models.CharField(max_length=150, null=False, blank=False, default="")
    numeroc = models.IntegerField(unique=True, null=False, blank=False, default=0)
    quantidadec = models.IntegerField(choices=[(1,"1"),(2,"2"),(3,"3")], default=1, null=False, blank=False )
    tipoc = models.CharField(max_length=70, choices=[("com", "Com manga"),("sem", "Sem manga")], default="com")
